...
When the app starts, Chainlit will ask for the following:
...
After entering these details, the agent initializes and starts the chat.
...
The agent prevents harmful actions unless explicitly approved, such as:

- `DROP DATABASE`
- `DROP TABLE`
- `TRUNCATE`
- Mass deletion without a `WHERE` clause
